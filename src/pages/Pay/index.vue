  ...
  <div class="pay-main">
    ...
    <div class="pay-container">
      ...
      <div class="checkout-info">
        <h4>重要说明：</h4>
        <ol>
          <li>无名百货支付平台目前支持<span class="zfb">支付宝</span>支付方式。</li>
  ...
  methods: {
    ...
    async open() {
      ...
      this.$alert(`<img src=${url} />`, "微信支付", {
        center: true,//文本居中
        dangerouslyUseHTMLString: true,//是否将message属性占位HTML片段处理
        showCancelButton: true,//是否显示取消按钮
        cancelButtonText: '支付遇见按钮',//取消按钮文字
        confirmButtonText: '已支付成功',//确定按钮文本
        showClose: false,//右上角叉取消显示
        // 关闭弹出框的回调函数
        beforeClose: (type, instance, done) => {
          // type代表点击的是取消cancel按钮还是确定confrim按钮
          // instance代表的是当前组件实例
          // done:关闭弹出框的方法
          if (type === "cancel") {
            alert('请联系管理员处理');
